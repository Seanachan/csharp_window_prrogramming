...
namespace NCKU_hw4_1_1
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            listView1.MouseDown += new MouseEventHandler(listView_MouseDoubleClick);
            listView2.MouseDown += new MouseEventHandler(listView_MouseDoubleClick);
            listView3.MouseDown += new MouseEventHandler(listView_MouseDoubleClick);
            listView4.MouseDown += new MouseEventHandler(listView_MouseDoubleClick);
        ...
        private void listView_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            {
                // 获取 ListView 可见区域的范围
                Rectangle listViewRect = listView.ClientRectangle;

                // 计算最后一项的底部，确保在最后一项下方的区域也被识别为空白区域
                int lastItemBottom = (listView.Items.Count > 0) ? listView.Items[listView.Items.Count - 1].Bounds.Bottom : 0;
